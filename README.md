...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/5n1KzN9B2H)
...
```sh
npx nx serve dream-spa
```

To create a production bundle:

```sh
npx nx build dream-spa
```

To see all available targets to run for a project, run:

```sh
npx nx show project dream-spa
```
